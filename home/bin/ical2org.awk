...
BEGIN {
    ...
    author = ENVIRON["AUTHOR"] != "" ? ENVIRON["AUTHOR"] : "Justin Silverman"

    # and to your email address
    emailaddress = ENVIRON["EMAIL"] != "" ? ENVIRON["EMAIL"] : "jds6696@psu.edu"

    # calendar/category name for display in org-mode
    calendarname = ENVIRON["CALENDAR"] != "" ? ENVIRON["CALENDAR"] : "cal-psu"
